              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(submission.quote?.status || 'pending')}`}>
                      <i className={`fas ${getStatusIcon(submission.quote?.status || 'pending')} mr-1`}></i>
